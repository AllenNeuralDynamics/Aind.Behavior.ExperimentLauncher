...
class TestBaseLauncher(unittest.TestCase):
    ...
    def test_cli_wrapper(self, mock_parse_known_args):
        mock_parse_known_args.return_value = (argparse.Namespace(data_dir='/fake/data/dir', repository_dir=None, config_library_dir=None, create_directories=False, debug=False, allow_dirty=False, skip_hardware_validation=False), [])
    ...
    def test_cli_args_integration(self, mock_parse_known_args):
        mock_parse_known_args.return_value = (argparse.Namespace(data_dir='/fake/data/dir', repository_dir=None, config_library_dir=None, create_directories=True, debug=True, allow_dirty=True, skip_hardware_validation=True), [])
